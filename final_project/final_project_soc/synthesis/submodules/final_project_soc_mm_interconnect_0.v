...
module final_project_soc_mm_interconnect_0 (
		...
		input  wire        VGA_pixel_controller_0_RESET_reset_bridge_in_reset_reset, // VGA_pixel_controller_0_RESET_reset_bridge_in_reset.reset
		...
		output wire [15:0] VGA_pixel_controller_0_avl_mm_slave_address,              //                VGA_pixel_controller_0_avl_mm_slave.address
		output wire        VGA_pixel_controller_0_avl_mm_slave_write,                //                                                   .write
		output wire        VGA_pixel_controller_0_avl_mm_slave_read,                 //                                                   .read
		input  wire [31:0] VGA_pixel_controller_0_avl_mm_slave_readdata,             //                                                   .readdata
		output wire [31:0] VGA_pixel_controller_0_avl_mm_slave_writedata,            //                                                   .writedata
		output wire [3:0]  VGA_pixel_controller_0_avl_mm_slave_byteenable,           //                                                   .byteenable
		output wire        VGA_pixel_controller_0_avl_mm_slave_chipselect            //                                                   .chipselect
	);
	...
	wire   [31:0] vga_pixel_controller_0_avl_mm_slave_agent_m0_readdata;                              // VGA_pixel_controller_0_avl_mm_slave_translator:uav_readdata -> VGA_pixel_controller_0_avl_mm_slave_agent:m0_readdata
	wire          vga_pixel_controller_0_avl_mm_slave_agent_m0_waitrequest;                           // VGA_pixel_controller_0_avl_mm_slave_translator:uav_waitrequest -> VGA_pixel_controller_0_avl_mm_slave_agent:m0_waitrequest
	wire          vga_pixel_controller_0_avl_mm_slave_agent_m0_debugaccess;                           // VGA_pixel_controller_0_avl_mm_slave_agent:m0_debugaccess -> VGA_pixel_controller_0_avl_mm_slave_translator:uav_debugaccess
	wire   [27:0] vga_pixel_controller_0_avl_mm_slave_agent_m0_address;                               // VGA_pixel_controller_0_avl_mm_slave_agent:m0_address -> VGA_pixel_controller_0_avl_mm_slave_translator:uav_address
	wire    [3:0] vga_pixel_controller_0_avl_mm_slave_agent_m0_byteenable;                            // VGA_pixel_controller_0_avl_mm_slave_agent:m0_byteenable -> VGA_pixel_controller_0_avl_mm_slave_translator:uav_byteenable
	wire          vga_pixel_controller_0_avl_mm_slave_agent_m0_read;                                  // VGA_pixel_controller_0_avl_mm_slave_agent:m0_read -> VGA_pixel_controller_0_avl_mm_slave_translator:uav_read
	wire          vga_pixel_controller_0_avl_mm_slave_agent_m0_readdatavalid;                         // VGA_pixel_controller_0_avl_mm_slave_translator:uav_readdatavalid -> VGA_pixel_controller_0_avl_mm_slave_agent:m0_readdatavalid
	wire          vga_pixel_controller_0_avl_mm_slave_agent_m0_lock;                                  // VGA_pixel_controller_0_avl_mm_slave_agent:m0_lock -> VGA_pixel_controller_0_avl_mm_slave_translator:uav_lock
	wire   [31:0] vga_pixel_controller_0_avl_mm_slave_agent_m0_writedata;                             // VGA_pixel_controller_0_avl_mm_slave_agent:m0_writedata -> VGA_pixel_controller_0_avl_mm_slave_translator:uav_writedata
	wire          vga_pixel_controller_0_avl_mm_slave_agent_m0_write;                                 // VGA_pixel_controller_0_avl_mm_slave_agent:m0_write -> VGA_pixel_controller_0_avl_mm_slave_translator:uav_write
	wire    [2:0] vga_pixel_controller_0_avl_mm_slave_agent_m0_burstcount;                            // VGA_pixel_controller_0_avl_mm_slave_agent:m0_burstcount -> VGA_pixel_controller_0_avl_mm_slave_translator:uav_burstcount
	wire          vga_pixel_controller_0_avl_mm_slave_agent_rf_source_valid;                          // VGA_pixel_controller_0_avl_mm_slave_agent:rf_source_valid -> VGA_pixel_controller_0_avl_mm_slave_agent_rsp_fifo:in_valid
	wire  [106:0] vga_pixel_controller_0_avl_mm_slave_agent_rf_source_data;                           // VGA_pixel_controller_0_avl_mm_slave_agent:rf_source_data -> VGA_pixel_controller_0_avl_mm_slave_agent_rsp_fifo:in_data
	wire          vga_pixel_controller_0_avl_mm_slave_agent_rf_source_ready;                          // VGA_pixel_controller_0_avl_mm_slave_agent_rsp_fifo:in_ready -> VGA_pixel_controller_0_avl_mm_slave_agent:rf_source_ready
	wire          vga_pixel_controller_0_avl_mm_slave_agent_rf_source_startofpacket;                  // VGA_pixel_controller_0_avl_mm_slave_agent:rf_source_startofpacket -> VGA_pixel_controller_0_avl_mm_slave_agent_rsp_fifo:in_startofpacket
	wire          vga_pixel_controller_0_avl_mm_slave_agent_rf_source_endofpacket;                    // VGA_pixel_controller_0_avl_mm_slave_agent:rf_source_endofpacket -> VGA_pixel_controller_0_avl_mm_slave_agent_rsp_fifo:in_endofpacket
	wire          vga_pixel_controller_0_avl_mm_slave_agent_rsp_fifo_out_valid;                       // VGA_pixel_controller_0_avl_mm_slave_agent_rsp_fifo:out_valid -> VGA_pixel_controller_0_avl_mm_slave_agent:rf_sink_valid
	wire  [106:0] vga_pixel_controller_0_avl_mm_slave_agent_rsp_fifo_out_data;                        // VGA_pixel_controller_0_avl_mm_slave_agent_rsp_fifo:out_data -> VGA_pixel_controller_0_avl_mm_slave_agent:rf_sink_data
	wire          vga_pixel_controller_0_avl_mm_slave_agent_rsp_fifo_out_ready;                       // VGA_pixel_controller_0_avl_mm_slave_agent:rf_sink_ready -> VGA_pixel_controller_0_avl_mm_slave_agent_rsp_fifo:out_ready
	wire          vga_pixel_controller_0_avl_mm_slave_agent_rsp_fifo_out_startofpacket;               // VGA_pixel_controller_0_avl_mm_slave_agent_rsp_fifo:out_startofpacket -> VGA_pixel_controller_0_avl_mm_slave_agent:rf_sink_startofpacket
	wire          vga_pixel_controller_0_avl_mm_slave_agent_rsp_fifo_out_endofpacket;                 // VGA_pixel_controller_0_avl_mm_slave_agent_rsp_fifo:out_endofpacket -> VGA_pixel_controller_0_avl_mm_slave_agent:rf_sink_endofpacket
	wire          cmd_mux_001_src_valid;                                                              // cmd_mux_001:src_valid -> VGA_pixel_controller_0_avl_mm_slave_agent:cp_valid
	wire  [105:0] cmd_mux_001_src_data;                                                               // cmd_mux_001:src_data -> VGA_pixel_controller_0_avl_mm_slave_agent:cp_data
	wire          cmd_mux_001_src_ready;                                                              // VGA_pixel_controller_0_avl_mm_slave_agent:cp_ready -> cmd_mux_001:src_ready
	wire   [14:0] cmd_mux_001_src_channel;                                                            // cmd_mux_001:src_channel -> VGA_pixel_controller_0_avl_mm_slave_agent:cp_channel
	wire          cmd_mux_001_src_startofpacket;                                                      // cmd_mux_001:src_startofpacket -> VGA_pixel_controller_0_avl_mm_slave_agent:cp_startofpacket
	wire          cmd_mux_001_src_endofpacket;                                                        // cmd_mux_001:src_endofpacket -> VGA_pixel_controller_0_avl_mm_slave_agent:cp_endofpacket
	...
	wire          vga_pixel_controller_0_avl_mm_slave_agent_rp_valid;                                 // VGA_pixel_controller_0_avl_mm_slave_agent:rp_valid -> router_003:sink_valid
	wire  [105:0] vga_pixel_controller_0_avl_mm_slave_agent_rp_data;                                  // VGA_pixel_controller_0_avl_mm_slave_agent:rp_data -> router_003:sink_data
	wire          vga_pixel_controller_0_avl_mm_slave_agent_rp_ready;                                 // router_003:sink_ready -> VGA_pixel_controller_0_avl_mm_slave_agent:rp_ready
	wire          vga_pixel_controller_0_avl_mm_slave_agent_rp_startofpacket;                         // VGA_pixel_controller_0_avl_mm_slave_agent:rp_startofpacket -> router_003:sink_startofpacket
	wire          vga_pixel_controller_0_avl_mm_slave_agent_rp_endofpacket;                           // VGA_pixel_controller_0_avl_mm_slave_agent:rp_endofpacket -> router_003:sink_endofpacket
	...
	wire          vga_pixel_controller_0_avl_mm_slave_agent_rdata_fifo_src_valid;                     // VGA_pixel_controller_0_avl_mm_slave_agent:rdata_fifo_src_valid -> avalon_st_adapter_001:in_0_valid
	wire   [33:0] vga_pixel_controller_0_avl_mm_slave_agent_rdata_fifo_src_data;                      // VGA_pixel_controller_0_avl_mm_slave_agent:rdata_fifo_src_data -> avalon_st_adapter_001:in_0_data
	wire          vga_pixel_controller_0_avl_mm_slave_agent_rdata_fifo_src_ready;                     // avalon_st_adapter_001:in_0_ready -> VGA_pixel_controller_0_avl_mm_slave_agent:rdata_fifo_src_ready
	wire          avalon_st_adapter_001_out_0_valid;                                                  // avalon_st_adapter_001:out_0_valid -> VGA_pixel_controller_0_avl_mm_slave_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_001_out_0_data;                                                   // avalon_st_adapter_001:out_0_data -> VGA_pixel_controller_0_avl_mm_slave_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_001_out_0_ready;                                                  // VGA_pixel_controller_0_avl_mm_slave_agent:rdata_fifo_sink_ready -> avalon_st_adapter_001:out_0_ready
	wire    [0:0] avalon_st_adapter_001_out_0_error;                                                  // avalon_st_adapter_001:out_0_error -> VGA_pixel_controller_0_avl_mm_slave_agent:rdata_fifo_sink_error
	...
	altera_merlin_slave_translator #(
		...
		.AV_SETUP_WAIT_CYCLES           (0),
		.AV_DATA_HOLD_CYCLES            (0)
	) vga_pixel_controller_0_avl_mm_slave_translator (
		.clk                    (clk_0_clk_clk),                                              //                      clk.clk
		.reset                  (VGA_pixel_controller_0_RESET_reset_bridge_in_reset_reset),   //                    reset.reset
		.uav_address            (vga_pixel_controller_0_avl_mm_slave_agent_m0_address),       // avalon_universal_slave_0.address
		.uav_burstcount         (vga_pixel_controller_0_avl_mm_slave_agent_m0_burstcount),    //                         .burstcount
		.uav_read               (vga_pixel_controller_0_avl_mm_slave_agent_m0_read),          //                         .read
		.uav_write              (vga_pixel_controller_0_avl_mm_slave_agent_m0_write),         //                         .write
		.uav_waitrequest        (vga_pixel_controller_0_avl_mm_slave_agent_m0_waitrequest),   //                         .waitrequest
		.uav_readdatavalid      (vga_pixel_controller_0_avl_mm_slave_agent_m0_readdatavalid), //                         .readdatavalid
		.uav_byteenable         (vga_pixel_controller_0_avl_mm_slave_agent_m0_byteenable),    //                         .byteenable
		.uav_readdata           (vga_pixel_controller_0_avl_mm_slave_agent_m0_readdata),      //                         .readdata
		.uav_writedata          (vga_pixel_controller_0_avl_mm_slave_agent_m0_writedata),     //                         .writedata
		.uav_lock               (vga_pixel_controller_0_avl_mm_slave_agent_m0_lock),          //                         .lock
		.uav_debugaccess        (vga_pixel_controller_0_avl_mm_slave_agent_m0_debugaccess),   //                         .debugaccess
		.av_address             (VGA_pixel_controller_0_avl_mm_slave_address),                //      avalon_anti_slave_0.address
		.av_write               (VGA_pixel_controller_0_avl_mm_slave_write),                  //                         .write
		.av_read                (VGA_pixel_controller_0_avl_mm_slave_read),                   //                         .read
		.av_readdata            (VGA_pixel_controller_0_avl_mm_slave_readdata),               //                         .readdata
		.av_writedata           (VGA_pixel_controller_0_avl_mm_slave_writedata),              //                         .writedata
		.av_byteenable          (VGA_pixel_controller_0_avl_mm_slave_byteenable),             //                         .byteenable
		.av_chipselect          (VGA_pixel_controller_0_avl_mm_slave_chipselect),             //                         .chipselect
		.av_begintransfer       (),                                                           //              (terminated)
		.av_beginbursttransfer  (),                                                           //              (terminated)
		.av_burstcount          (),                                                           //              (terminated)
		.av_readdatavalid       (1'b0),                                                       //              (terminated)
	...
	altera_merlin_slave_agent #(
		...
		.USE_WRITERESPONSE         (0),
		.ECC_ENABLE                (0)
	) vga_pixel_controller_0_avl_mm_slave_agent (
		.clk                     (clk_0_clk_clk),                                                        //             clk.clk
		.reset                   (VGA_pixel_controller_0_RESET_reset_bridge_in_reset_reset),             //       clk_reset.reset
		.m0_address              (vga_pixel_controller_0_avl_mm_slave_agent_m0_address),                 //              m0.address
		.m0_burstcount           (vga_pixel_controller_0_avl_mm_slave_agent_m0_burstcount),              //                .burstcount
		.m0_byteenable           (vga_pixel_controller_0_avl_mm_slave_agent_m0_byteenable),              //                .byteenable
		.m0_debugaccess          (vga_pixel_controller_0_avl_mm_slave_agent_m0_debugaccess),             //                .debugaccess
		.m0_lock                 (vga_pixel_controller_0_avl_mm_slave_agent_m0_lock),                    //                .lock
		.m0_readdata             (vga_pixel_controller_0_avl_mm_slave_agent_m0_readdata),                //                .readdata
		.m0_readdatavalid        (vga_pixel_controller_0_avl_mm_slave_agent_m0_readdatavalid),           //                .readdatavalid
		.m0_read                 (vga_pixel_controller_0_avl_mm_slave_agent_m0_read),                    //                .read
		.m0_waitrequest          (vga_pixel_controller_0_avl_mm_slave_agent_m0_waitrequest),             //                .waitrequest
		.m0_writedata            (vga_pixel_controller_0_avl_mm_slave_agent_m0_writedata),               //                .writedata
		.m0_write                (vga_pixel_controller_0_avl_mm_slave_agent_m0_write),                   //                .write
		.rp_endofpacket          (vga_pixel_controller_0_avl_mm_slave_agent_rp_endofpacket),             //              rp.endofpacket
		.rp_ready                (vga_pixel_controller_0_avl_mm_slave_agent_rp_ready),                   //                .ready
		.rp_valid                (vga_pixel_controller_0_avl_mm_slave_agent_rp_valid),                   //                .valid
		.rp_data                 (vga_pixel_controller_0_avl_mm_slave_agent_rp_data),                    //                .data
		.rp_startofpacket        (vga_pixel_controller_0_avl_mm_slave_agent_rp_startofpacket),           //                .startofpacket
		...
		.rf_sink_ready           (vga_pixel_controller_0_avl_mm_slave_agent_rsp_fifo_out_ready),         //         rf_sink.ready
		.rf_sink_valid           (vga_pixel_controller_0_avl_mm_slave_agent_rsp_fifo_out_valid),         //                .valid
		.rf_sink_startofpacket   (vga_pixel_controller_0_avl_mm_slave_agent_rsp_fifo_out_startofpacket), //                .startofpacket
		.rf_sink_endofpacket     (vga_pixel_controller_0_avl_mm_slave_agent_rsp_fifo_out_endofpacket),   //                .endofpacket
		.rf_sink_data            (vga_pixel_controller_0_avl_mm_slave_agent_rsp_fifo_out_data),          //                .data
		.rf_source_ready         (vga_pixel_controller_0_avl_mm_slave_agent_rf_source_ready),            //       rf_source.ready
		.rf_source_valid         (vga_pixel_controller_0_avl_mm_slave_agent_rf_source_valid),            //                .valid
		.rf_source_startofpacket (vga_pixel_controller_0_avl_mm_slave_agent_rf_source_startofpacket),    //                .startofpacket
		.rf_source_endofpacket   (vga_pixel_controller_0_avl_mm_slave_agent_rf_source_endofpacket),      //                .endofpacket
		.rf_source_data          (vga_pixel_controller_0_avl_mm_slave_agent_rf_source_data),             //                .data
		.rdata_fifo_sink_ready   (avalon_st_adapter_001_out_0_ready),                                    // rdata_fifo_sink.ready
		.rdata_fifo_sink_valid   (avalon_st_adapter_001_out_0_valid),                                    //                .valid
		.rdata_fifo_sink_data    (avalon_st_adapter_001_out_0_data),                                     //                .data
		.rdata_fifo_sink_error   (avalon_st_adapter_001_out_0_error),                                    //                .error
		.rdata_fifo_src_ready    (vga_pixel_controller_0_avl_mm_slave_agent_rdata_fifo_src_ready),       //  rdata_fifo_src.ready
		.rdata_fifo_src_valid    (vga_pixel_controller_0_avl_mm_slave_agent_rdata_fifo_src_valid),       //                .valid
		.rdata_fifo_src_data     (vga_pixel_controller_0_avl_mm_slave_agent_rdata_fifo_src_data),        //                .data
		.m0_response             (2'b00),                                                                //     (terminated)
		.m0_writeresponsevalid   (1'b0)                                                                  //     (terminated)
	);
	...
	altera_avalon_sc_fifo #(
		...
		.USE_ALMOST_FULL_IF  (0),
		.USE_ALMOST_EMPTY_IF (0)
	) vga_pixel_controller_0_avl_mm_slave_agent_rsp_fifo (
		.clk               (clk_0_clk_clk),                                                        //       clk.clk
		.reset             (VGA_pixel_controller_0_RESET_reset_bridge_in_reset_reset),             // clk_reset.reset
		.in_data           (vga_pixel_controller_0_avl_mm_slave_agent_rf_source_data),             //        in.data
		.in_valid          (vga_pixel_controller_0_avl_mm_slave_agent_rf_source_valid),            //          .valid
		.in_ready          (vga_pixel_controller_0_avl_mm_slave_agent_rf_source_ready),            //          .ready
		.in_startofpacket  (vga_pixel_controller_0_avl_mm_slave_agent_rf_source_startofpacket),    //          .startofpacket
		.in_endofpacket    (vga_pixel_controller_0_avl_mm_slave_agent_rf_source_endofpacket),      //          .endofpacket
		.out_data          (vga_pixel_controller_0_avl_mm_slave_agent_rsp_fifo_out_data),          //       out.data
		.out_valid         (vga_pixel_controller_0_avl_mm_slave_agent_rsp_fifo_out_valid),         //          .valid
		.out_ready         (vga_pixel_controller_0_avl_mm_slave_agent_rsp_fifo_out_ready),         //          .ready
		.out_startofpacket (vga_pixel_controller_0_avl_mm_slave_agent_rsp_fifo_out_startofpacket), //          .startofpacket
		.out_endofpacket   (vga_pixel_controller_0_avl_mm_slave_agent_rsp_fifo_out_endofpacket),   //          .endofpacket
		.csr_address       (2'b00),                                                                // (terminated)
		.csr_read          (1'b0),                                                                 // (terminated)
		.csr_write         (1'b0),                                                                 // (terminated)
		.csr_readdata      (),                                                                     // (terminated)
	...
	final_project_soc_mm_interconnect_0_router_003 router_003 (
		.sink_ready         (vga_pixel_controller_0_avl_mm_slave_agent_rp_ready),         //      sink.ready
		.sink_valid         (vga_pixel_controller_0_avl_mm_slave_agent_rp_valid),         //          .valid
		.sink_data          (vga_pixel_controller_0_avl_mm_slave_agent_rp_data),          //          .data
		.sink_startofpacket (vga_pixel_controller_0_avl_mm_slave_agent_rp_startofpacket), //          .startofpacket
		.sink_endofpacket   (vga_pixel_controller_0_avl_mm_slave_agent_rp_endofpacket),   //          .endofpacket
		.clk                (clk_0_clk_clk),                                              //       clk.clk
		.reset              (VGA_pixel_controller_0_RESET_reset_bridge_in_reset_reset),   // clk_reset.reset
	...
	final_project_soc_mm_interconnect_0_avalon_st_adapter #(
		...
		.in_clk_0_clk   (clk_0_clk_clk),                                                  // in_clk_0.clk
		.in_rst_0_reset (VGA_pixel_controller_0_RESET_reset_bridge_in_reset_reset),       // in_rst_0.reset
		.in_0_data      (vga_pixel_controller_0_avl_mm_slave_agent_rdata_fifo_src_data),  //     in_0.data
		.in_0_valid     (vga_pixel_controller_0_avl_mm_slave_agent_rdata_fifo_src_valid), //         .valid
		.in_0_ready     (vga_pixel_controller_0_avl_mm_slave_agent_rdata_fifo_src_ready), //         .ready
