...
volatile static alt_u32 buffer_ptr = 0;
volatile static BYTE last_keycodes[6] = {0, 0, 0, 0, 0, 0};
volatile static char keyboard_buffer[DISCORD_CHAR_LIM+1];
volatile static struct KB_EVENTS keyboard_events = {0, 0, 0, 0};
